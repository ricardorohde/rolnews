    ...
    <div class="capa">
        ...
        <div class="row marginBottom">
            <div class="col-md-6">
                <div class="row marginBottom">
                    <div class="col-md-12">
                        <div class="boxMaisNews borderTopRed radius shadowBottom"></div>
                    </div>
                </div>
                <div class="row marginBottom">
                    <div class="col-md-6">
        ...
        <div class="row marginBottom">
            <div class="col-md-12">
                ...
                <div class="row marginBottom">
                    <div class="col-md-4">
                        <div class="row marginBottom">
                            <div class="col-md-12"><div class="boxMaisNews radius shadowBottom"></div></div>
                        </div>
                        <div class="row marginBottom">
                            <div class="col-md-12"><div class="boxMaisNews radius shadowBottom"></div></div>
                        </div>
                    </div>
                    <div class="col-md-4"><div class="boxMaisNews radius shadowBottom"></div></div>
                    <div class="col-md-4"><div class="boxMaisNews radius shadowBottom"></div></div>
                </div>
            </div>
        </div>
        ...
        <div class="row marginBottom">
            <div class="col-md-4">
                <div class="blcMaisNews ">
                    ...
                    <div class="row marginBottom">
                        <div class="col-md-12"><div class="boxMaisNews radius shadowBottom">teste</div></div>
                    </div>
                    <div class="row marginBottom">
                        <div class="col-md-12"><div class="boxMaisNews radius shadowBottom">teste</div></div>
                    </div>
