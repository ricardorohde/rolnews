...
<div style="
    ...
    margin-left: -50%;     transition: 0.4s;" id="banner-eucurtoro"> 
 
    <div type="button" 
 
onclick="document.getElementById('banner-eucurtoro').style.bottom = '-180px'" style="    position: relative;
...
<img src="http://facilitando.com/images/seta-fechar.png" style=" width: 100%;   -webkit-filter: brightness(1%);"></div>
 
<div type="button" 
 
onclick="document.getElementById('banner-eucurtoro').style.bottom = '30px'" style="       position: relative;
...
<img src="http://facilitando.com/images/seta-abrir.png" style=" width: 100%; text-shadow:#000 0px 0px 10px;  -webkit-filter: brightness(1%);"></div>
...
<embed width="100%"  height="100%" name="plugin" id="plugin" src="<?= HOME . '/uploads/banners/swf/' . $bannerSwf2; ?>" type="application/x-shockwave-flash" z-index="20000"> </div>
</div>
