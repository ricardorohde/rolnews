        ...
        <div class="col-md-12">
            ...
            if (isset($dados) && $dados['SendPostForm']):
                ...
                if (!$cadastra->getResult()):
                    ...
                    header("Location: painel.php?exe=produtos/listar&acao=editar&id={$idEdit}");
                endif;
                var_dump($cadastra);
            else:
                $read = new Read;
                $read->ExeRead("produtos", "WHERE id = :id", "id={$idEdit}");
                if (!$read->getResult()):
                    header("Location: painel.php?exe=produtos/listar");
                else:
