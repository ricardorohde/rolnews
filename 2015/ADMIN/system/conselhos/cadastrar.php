<section class="content-header">
    <h1>
        Cadastrar Conselho 
        <small>Cadastros de Conselhos</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="painel.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="painel.php?exe=conselhos/listar">Conselho</a></li>
        <li class="active">Cadastrar Conselho</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            ...
            if (isset($dados) && $dados['SendPostForm']):
                ...
                if (!$cadastra->getResult()):
                    ...
                    header("Location: painel.php?exe=conselhos/listar&acao=cadastrar&id={$cadastra->getResult()}");
                endif;
            endif;
            ?>
