<section class="content-header">
    <h1>
        Editar Equipe 
        <small>Edição de Cadastros de Equipe</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="painel.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="painel.php?exe=equipe/listar">Equipe</a></li>
        <li class="active">Editar Equipe</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            ...
            if (isset($dados) && $dados['SendPostForm']):
                ...
                if (!$cadastra->getResult()):
                    ...
                    header("Location: painel.php?exe=equipe/listar&acao=cadastrar&id={$idEdit}");
                endif;
            else:
                $read = new Read;
                $read->ExeRead("equipe", "WHERE id = :id", "id={$idEdit}");
                if (!$read->getResult()):
                    header("Location: painel.php?exe=equipe/listar");
                else:
