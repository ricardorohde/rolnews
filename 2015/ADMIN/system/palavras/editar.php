        ...
        <div class="col-md-12">
            ...
            if (isset($dados) && $dados['SendPostForm']):
                ...
                if (!$cadastra->getResult()):
                    ...
                    header("Location: painel.php?exe=palavras/listar&acao=editar&id={$idEdit}");
                endif;
            else:
                $read = new Read;
                $read->ExeRead("presidentes_palavra", "WHERE id_palavra = :id", "id={$idEdit}");
                if (!$read->getResult()):
                    header("Location: painel.php?exe=palavras/listar");
                else:
