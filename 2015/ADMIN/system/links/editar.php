<section class="content-header">
    <h1>
        Editar Link 
        <small>Edição de cadastro de Link</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="painel.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="painel.php?exe=links/listar">Links</a></li>
        <li class="active">Edição de Link</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            ...
            if (isset($dados) && $dados['SendPostForm']):
                ...
                if (!$cadastra->getResult()):
                    ...
                    header("Location: painel.php?exe=links/listar&acao=editar&id={$idEdit}");
                endif;
            else:
                $read = new Read;
                $read->ExeRead("links", "WHERE id = :id", "id={$idEdit}");
                if (!$read->getResult()):
                    header("Location: painel.php?exe=links/listar");
                else:
