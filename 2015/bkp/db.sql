...
-- Copiando dados para a tabela _rolnews_2015.menu: ~5 rows (aproximadamente)
DELETE FROM `menu`;
...
-- Copiando dados para a tabela _rolnews_2015.menu_sub: ~10 rows (aproximadamente)
...
-- Copiando dados para a tabela _rolnews_2015.noticias_categoria: ~4 rows (aproximadamente)
DELETE FROM `noticias_categoria`;
/*!40000 ALTER TABLE `noticias_categoria` DISABLE KEYS */;
INSERT INTO `noticias_categoria` (`id_categoria`, `categoria`) VALUES
	(1, 'POLITICA'),
	(2, 'ESPORTE'),
	(3, 'CULTURA'),
	(4, 'POLICIAL');
...
INSERT INTO `ws_siteviews_online` (`online_id`, `online_session`, `online_startview`, `online_endview`, `online_ip`, `online_url`, `online_agent`, `agent_name`) VALUES
	(14, 'ikeuk4nm3l96h9ajp9co631f50', '2015-11-13 10:11:26', '2015-11-14 08:31:57', '::1', '/servidor/rolnews/2015/', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.118 Safari/537.36', 'Chrome');
